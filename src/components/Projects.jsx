...
const projects = [
  {
    ...
    gradient: 'bg-gradient-to-br from-(--color-navy-light) via-(--color-navy) to-(--color-bg)',
  },
  {
    title: 'Padel',
    tag: 'MOBILE / BACKEND',
    ...
    gradient: 'bg-gradient-to-tr from-(--color-muted)/50 via-(--color-navy) to-(--color-bg)',
  },
  {
    title: 'Costa Coffee',
    ...
    gradient: 'bg-gradient-to-b from-(--color-bg) via-(--color-navy-light) to-(--color-surface)',
  },
  {
    ...
    gradient: 'bg-gradient-to-br from-(--color-text)/15 via-(--color-navy-light) to-(--color-bg)',
  },
  {
    title: 'Pharmacy App',
    tag: 'MOBILE',
    ...
    gradient: 'bg-gradient-to-tr from-(--color-muted)/35 via-(--color-surface) to-(--color-bg)',
  },
  {
    ...
    gradient: 'bg-gradient-to-r from-(--color-navy) via-(--color-muted)/25 to-(--color-navy-light)',
  },
  {
    ...
    gradient: 'bg-gradient-to-bl from-(--color-muted)/45 via-(--color-navy-light) to-(--color-navy)',
  },
]
